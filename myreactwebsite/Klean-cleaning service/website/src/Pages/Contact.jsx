...
function Contact() {
  ...
  {
      e.preventDefault();
      fetch(`https://reacttest-cbbbb-default-rtdb.firebaseio.com/contacts.json`, {
      method: 'POST',
            ...
            <div className="row">
                ...
                <div className="contact-form">
                    ...
                    <div className="form-row">
                        ...
                        <input type="text" name="name" value={formvalue.name} onChange={handlechange} className="form-control p-4" id="name" placeholder="Your Name" required="required" data-validation-required-message="Please enter your name" />
                        <p className="help-block text-danger" />
                        </div>
                        <div className="col-sm-6 control-group">
                        <input type="email" name="Email" value={formvalue.Email} onChange={handlechange}  className="form-control p-4" id="Email" placeholder="Your Email" required="required" data-validation-required-message="Please enter your email" />
                        <p className="help-block text-danger" />
                        </div>
                    </div>
                    
                    <div className="control-group">
                        <textarea name="Message" onChange={handlechange}  value={formvalue.Message} className="form-control p-4" rows={6} id="Message" placeholder="Message" required="required" data-validation-required-message="Please enter your message" >
                            {formvalue.Message}
                        </textarea>
                        <p className="help-block text-danger" />
                    </div>
