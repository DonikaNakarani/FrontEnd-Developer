                        ...
                        <div className="row bg-dark d-none d-lg-flex">
                            ...
                            <div className="col-lg-5 text-right">
                                <div className="d-inline-flex align-items-center pr-2">
                                    ...
                                    <a className="text-primary p-2" href="https://twitter.com/i/flow/login">
                                        <i className="fab fa-twitter" />
                                    </a>
                                    <a className="text-primary p-2" href="https://in.linkedin.com/">
                                        <i className="fab fa-linkedin-in" />
                                    </a>
                                    <a className="text-primary p-2" href="https://www.instagram.com/accounts/login/">
                        ...
                        <nav className="navbar navbar-expand-lg bg-white navbar-light p-0">
                            ...
                            <div className="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                                <div className="navbar-nav mr-auto py-0">
                                    ...
                                    <NavLink to="/form_Handeling" className="nav-item nav-link">Form1</NavLink>
                                    <NavLink to="/signup" className="nav-item nav-link">SignUp</NavLink>
                                    <NavLink to="/login" className="nav-item nav-link">Login</NavLink>
                                    <NavLink to="/single" className="nav-item nav-link">Single</NavLink>
