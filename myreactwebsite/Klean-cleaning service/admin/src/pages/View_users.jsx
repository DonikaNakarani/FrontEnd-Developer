...
function View_users() {
  ...
  function handelDelete(user_id){
    ...
    if(ans)
    {
    fetch(`https://reacttest-cbbbb-default-rtdb.firebaseio.com/users/${user_id}.json`, {
      method: 'DELETE',
    }).then((resp)=>resp.json())
    .then((data)=>viewUser());
    }
  ...
  function updatehandel(e){
      e.preventDefault();
      fetch(`https://reacttest-cbbbb-default-rtdb.firebaseio.com/users/${EditId}.json`, {
      method: 'PATCH',
  ...
  function handelstatus(id)
  {
    ...
    fetch(`https://reacttest-cbbbb-default-rtdb.firebaseio.com/users/${id}.json`)
    .then((resp)=>resp.json())
    .then((data)=>{
